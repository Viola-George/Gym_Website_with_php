...
<h1 style="color:red;font-size:34px;">Login </h1>
       ...
       <input type="password" class="reg-input" name="password" placeholder="Password..." required><br>
        ...
        <br>
         <p>Donot Have An Account ?<a href="register.php" 
         style="color: red;margin-left: 40%;padding-top: 50%;text-decoration-line: underline;">Register Now</a></p>
        <br>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-copy-right text-center">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> <a href="#" target="_blank">Viola George </a>
