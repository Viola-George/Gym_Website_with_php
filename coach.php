...
<body class="black-bg">
                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="logo">
                            ...
                            <a class="navbar-brand" href="home.php">Healthy Life</a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-40">
                            <div class="features-icon">
                                ...
                                <a href="https://api.whatsapp.com/send?text=<?php echo 'Coach Jon' ?>"><img src="assets/img/icon/whatsapp.png" alt=""></a>
                            </div>
                            <div class="features-caption">
                        ...
                        <div class="col-lg-12">
                            <div class="footer-copy-right text-center">
                                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                    ...
                                    </script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> <a href="https://www.TuitionsTonight.com" target="_blank">Viola George</a>
    ...
    <!-- <div style="left: 55%;background-color: transparent;" id="back-top">
         <img  src="images/chatbox.png"></a>
    </div> -->
    <!-- Scroll Up -->
    <div style="    right: 31px;
    bottom: 18px;
    position: fixed;">
        <!-- <script type="text/javascript">location.href = '../ChatApp/users.php';</script> -->
        <a title="Let's Chat" href="../ChatApp/users.php"><img src="images/chat.png"></a>
